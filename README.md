...
![Introducing the .dsl, .sty, and .sub files that are the backbone of every Penrose program](https://github.com/penrose/penrose/raw/docs-edit/assets/tutorial/intro/triple\_helvetica.png)
...
![](.gitbook/assets/2sets\_nolabel.png)
...
![](.gitbook/assets/addtion\_wg.png)
